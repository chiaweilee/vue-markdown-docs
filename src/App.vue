...
<style>
  ...
  .home .hero .action-button {
    ...
    border-bottom: 1px solid #0877cc
  }

  .home .hero .action-button:hover {
    background-color: #1292f6
  }
  ...
  .search-box input {
    ...
    /*background: #fff url(/api-doc/assets/img/search.83621669.svg) .6rem .5rem no-repeat;*/
  ...
  @media (min-width: 719px) {
    ...
    .nav-item > a:not(.external).router-link-active, .nav-item > a:not(.external):hover {
      margin-bottom: -2px;
      border-bottom: 2px solid #0d90f5
    }
  }
  ...
  #nprogress .peg {
    ...
    width: 100px;
    height: 100%;
    box-shadow: 0 0 10px #0984e3, 0 0 5px #0984e3;
    opacity: 1;
  ...
  /* feat: new */
  .nav-links .nav-item .dropdown-title {
    font-size: 1rem;
  }

  .nav-links .nav-item .nav-links .nav-item {
    font-size: 1rem;
    padding: .25rem 0 .25rem 1.5rem;
  }

  .nav-links .nav-item .nav-links .nav-item a {
    font-weight: 400;
  }
